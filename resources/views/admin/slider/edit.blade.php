                        ...
                        <div class="card card-custom example example-compact">
                            ...
                            <form class="form" id="kt_form_1" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-3 col-sm-12">Banner Description
                                            *</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <textarea name="description" rows="8" cols="80" id="banner_description"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="image" class="custom-file-input" id="banner_image" required />
                                                <label class="custom-file-label" for="customFile">Select an image to
                                                    upload</label>
                                            </div>
											<span class="form-text text-muted">Recommended Image Size: 1366 x 400</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 ml-lg-auto">
                                            <button type="submit" class="btn btn-primary font-weight-bold mr-2"
                                                name="submitButton">Update Banner</button>
